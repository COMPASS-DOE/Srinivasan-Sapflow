...
AIC(model.noint.ec) -> AIC_noint_ec #just SEC, no BACI


variable <- c("Model A", "Model B", "Model C", "Model D")
AIC <- c(AIC_initial, AIC_randominteraction,
         AIC_int_ec, AIC_noint_ec)
candidate <- c("without interaction in random effects",
               "with interaction in random effects", 
               "with Soil EC", "just Soil EC")

AIC <- data.frame(variable, AIC)
