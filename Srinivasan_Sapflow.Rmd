...
data <- readRDS("final_tmp_data.rds")
...
#R edits: comparison to whole day sapflow and whole growing season 
data %>%
...
tsb_1_wholeday %>%
  ...
  mutate(BA = ifelse(Year == 2021, "Before", BA)) -> tsb_2_wholeday

ggplot(tsb_2_wholeday, aes(Day, F_avg, color = ID, shape = BA)) +
...
current_skewness <- skewness(tsb_2_wholeday$F_avg)
print(paste("Current Skewness:", current_skewness))

# Logarithmic Transformation
log_transformed_response <- log(tsb_2_wholeday$F_avg + 1)

# Square Root Transformation
sqrt_transformed_response <- sqrt(tsb_2_wholeday$F_avg)

# Inverse Transformation
inv_transformed_response <- 1 / tsb_2_wholeday$F_avg
...
ggplot(tsb_2_wholeday, aes(F_avg)) + geom_histogram(fill = '#31688EFF') +
  facet_grid(Plot~.) +
  labs(y = NULL, x = "Average Sapflow", title = "Untransformed Data")
  

ggplot(tsb_2_wholeday, aes(sqrt(F_avg))) + geom_histogram(fill = '#31688EFF') +
  facet_grid(Plot~.) + 
