...
tempest_events <- bind_rows(
  ...
  tibble( Year = 2024, flood_start = "2024-06-11", flood_end = "2024-06-13"),
...
tsb_2_summary %>%
  ...
  stat_smooth(aes(x = soil_ec_avg, y = F_avg), method = 'lm',
              ...
              data = tsb_2 %>% filter(soil_ec_avg < 1200, Year != 2025)) +
  ...
  geom_point(aes(x = soil_ec_avg, y = F_avg, color = as.factor(Year)),
             data = tsb_2 %>% filter(soil_ec_avg < 1200, Year != 2025), alpha = 0.2) +
